...
class ArabicPlagiarismCSVDataset(Dataset):
    """
    Lit un CSV et renvoie pour chaque item :
      - s_ids, s_mask : tenseurs BERT pour fragment suspect
      - r_ids, r_mask : tenseurs BERT pour fragment source
